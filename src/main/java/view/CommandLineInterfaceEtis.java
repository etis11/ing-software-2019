 ...
 **/
public class CommandLineInterfaceEtis extends AbstractView {
     ...
     * @throws IOException
     */
    public CommandLineInterfaceEtis() throws IOException{
     ...
     * @param outputStream
     */
    public CommandLineInterfaceEtis(InputStream inputStream,  PrintStream outputStream){
